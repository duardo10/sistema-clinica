...
# Form implementation generated from reading ui file 'login_medico.ui'
#
...
class LoginMedico(object):
    """
    Classe responsavel por definir a interface grafica da tela de login do medico.
