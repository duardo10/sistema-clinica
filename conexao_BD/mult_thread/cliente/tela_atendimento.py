...
# Form implementation generated from reading ui file 'atendimento.ui'
#
...
class TelaAtendimento(object):
    """
     Classe responsavel por configurar a interface gráfica da janela de Atendimento.
    ...
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(100, 129, 531, 331))
...
"        }")
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(100, 480, 121, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"        }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "ATENDIMENTO"))
        self.pushButton.setText(_translate("MainWindow", "Iniciar Atendimento"))
        self.pushButton_2.setText(_translate("MainWindow", "Finalizar Atendimento"))
        self.pushButton_3.setText(_translate("MainWindow", "Adicionar Guichê"))
        self.pushButton_7.setText(_translate("MainWindow", "Excluir Guichê"))
        self.pushButton_4.setText(_translate("MainWindow", "Ativar um Guichê"))
        self.pushButton_6.setText(_translate("MainWindow", "Desativar um Guichê"))
